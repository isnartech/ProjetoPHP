<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        $result = mysqli_query($conexao, "INSERT INTO clientes (ordem,nome,rua,bairro,cidade,referencia,telefone,total,cpf,vendedor,data_venda,
...
<body>
    ...
    <div class="box">
        <form action="formulario.php" method="POST">
            <fieldset>
                <legend><b>Fórmulário de Clientes 1</b></legend>
                <br>
				<div class="inputBox">
